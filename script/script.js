...
const hiraganaQuestions = [
  ...
  { q: "ず", options:["zu","su","zu","zu"], answer:"zu", time:15 },
  { q: "ぜ", options:["ze","se","ze","ze"], answer:"ze", time:15 },
  { q: "ぞ", options:["zo","so","zo","zo"], answer:"zo", time:15 },
...
const katakanaQuestions = [
  ...
  { q: "ズ", options:["ず","す","ず","ず"], answer:"ず", time:15 },
  { q: "ゼ", options:["ぜ","せ","ぜ","ぜ"], answer:"ぜ", time:15 },
  { q: "ゾ", options:["ぞ","そ","ぞ","ぞ"], answer:"ぞ", time:15 },
  ...
  { q: "ヅ", options:["ず","づ","つ","ず"], answer:"ず", time:15 },
  { q: "デ", options:["で","て","だ","ぢ"], answer:"で", time:15 },
  { q: "ド", options:["ど","と","だ","ど"], answer:"ど", time:15 },
